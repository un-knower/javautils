...
import com.cenrise.commons.utils.FileUtil;
import com.cenrise.commons.utils.PrintUtil;
...
public class FileUtilTest extends SupportTest {
    ...
    public void testCountLines() throws IOException {
        ...
        String file = System.getProperty("user.dir") + "/src/test/resources/English.txt";
        Assert.assertEquals("文件行数计算有误", 5, FileUtil.countLines(new File(file)));
    }

    @Test
    public void testHash() {
        String file = System.getProperty("user.dir") + "/src/test/resources/ali.gif";
    ...
    public void testFileType() throws IOException {
        String efile = System.getProperty("user.dir") + "/src/test/resources/ali.gif";
        String hfile = System.getProperty("user.dir") + "/src/test/resources/tgepng";
    ...
    public void testModify() {
        String exefile = System.getProperty("user.dir") + "/src/test/resources/cmdexe";
    ...
    public void testLines() {
        ...
        String       efile = System.getProperty("user.dir") + "/src/test/resources/English.txt";
        ...
        String       gbkfile  = System.getProperty("user.dir") + "/src/test/resources/GBK.txt";
        ...
        String       utf8file  = System.getProperty("user.dir") + "/src/test/resources/UTF8.txt";
    ...
    public void testCleanFile() {
        ...
        String clearFile = System.getProperty("user.dir") + "/src/test/resources/temp/GBKTOUTF8.txt";
    ...
    public void testCopy() throws Exception {
        ...
        String copy = System.getProperty("user.dir") + "/src/test/resources/GBKTOUTF8.txt";
        String dest = System.getProperty("user.dir") + "/src/test/resources/temp/GBKTOUTF8.txt";
    ...
    public void testAppendLine() {
        ...
        File efile    = new File(System.getProperty("user.dir") + "/src/test/resources/EnglishWrite.txt");
        File gbkfile  = new File(System.getProperty("user.dir") + "/src/test/resources/GBKWrite.txt");
        File utf8file = new File(System.getProperty("user.dir") + "/src/test/resources/UTF8Write.txt");
    ...
    public void testDeleteFile() {
        ...
        String delete = System.getProperty("user.dir") + "/src/test/resources/temp/delete.txt";
        FileUtil.delFile(new File(delete));
    }

    @Test
    public void testDeleteBigFile() {
        System.out.println("快速删除超大文件");
        String delete = System.getProperty("user.dir") + "/src/test/resources/temp/bigfile.txt";
        FileUtil.deleteBigFile(new File(delete));
    }

    @Test
    public void testCopyDir() {
        FileUtil.copyDir(new File(System.getProperty("user.dir") + "/conf/"), System.getProperty("user.dir") + "/src/test/resources/temp/copy");
    }
    ...
    public void testCreateFiles() {
        ...
        String path  = System.getProperty("user.dir") + "/src/test/resources/temp/";
