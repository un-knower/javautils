...
public class DateUtil {
    ...
    private Calendar getStartCalendar() {
        ...
        calendar.set(Calendar.HOUR_OF_DAY, 0);//零点
    ...
    public static boolean sameDate3(Date d1, Date d2) {
        if (null == d1 || null == d2)
            return false;
