...
public class SFTPPUT {
    ...
    public void put(String filefullpath, String realSftpDirString) throws Exception {
        ...
        try {
            ...
            FileObject fileObject = SFTPClientVFS.getFileObject(filefullpath);
            sftpclient.put(fileObject, realSftpDirString);
        } catch (Exception e) {
...
//            sftpclient.get("/Users/yp-tc-m-2684/jiadp","/apps/tomcat7-40-tomcat-air-ticket-merchant/logs/catalina.out");
            ...
            sftpclient.put(fileObject, "/apps/tomcat7-40-tomcat-air-ticket-merchant/logs/北京天安门2.txt");
